...
export interface Actionable {
  ...
  onPressed?: BasicListener;
  onDoublePressed?: BasicListener1;
  onLongPressed?: BasicListener2;
  onPressedCancel?: BasicListener3;
  onHovered?: BasicListener4;
  /**
 ...
 */
export interface BasicListener {
  /**
 ...
 */
export interface BasicListener1 {
  /**
   * The action name to call
   */
  action: string;
 ...
 */
export interface BasicListener2 {
  /**
   * The action name to call
   */
  action: string;
 ...
 */
export interface BasicListener3 {
  /**
   * The action name to call
   */
  action: string;
 ...
 */
export interface BasicListener4 {
  /**
   * The action name to call
   */
  action: string;
...
export interface BasicListener5 {
  /**
   * The action name to call
   */
  action: string;
...
export interface Form {
  ...
  onSubmit?: BasicListener6;
}
/**
 * Callback when the user submits the form.
 */
export interface BasicListener6 {
  /**
   * The action name to call
   */
  action: string;
...
export interface Slider {
   ...
   */
  max?: number;
  onChanged?: BasicListener7;
  onChangeEnd?: BasicListener8;
  onChangeStart?: BasicListener9;
  /**
 ...
 */
export interface BasicListener7 {
  /**
   * The action name to call
   */
  action: string;
 ...
 */
export interface BasicListener8 {
  /**
   * The action name to call
   */
  action: string;
 ...
 */
export interface BasicListener9 {
  /**
   * The action name to call
   */
  action: string;
...
export interface TextField {
   ...
   */
  obscureText?: boolean;
  onAppPrivateCommand?: BasicListener11;
  onChanged?: BasicListener12;
  onEditingComplete?: BasicListener13;
  onSubmitted?: BasicListener14;
  onTap?: BasicListener15;
  /**
 ...
 */
export interface BasicListener10 {
  /**
   * The action name to call
   */
  action: string;
 ...
 */
export interface BasicListener11 {
  /**
   * The action name to call
   */
  action: string;
 ...
 */
export interface BasicListener12 {
  /**
   * The action name to call
   */
  action: string;
 ...
 */
export interface BasicListener13 {
  /**
   * The action name to call
   */
  action: string;
 ...
 */
export interface BasicListener14 {
  /**
   * The action name to call
   */
  action: string;
 ...
 */
export interface BasicListener15 {
  /**
   * The action name to call
   */
  action: string;
